...
function validateSpec(spec) {
    ...
    function _validateSpecItem(key){
        ...
        utils.optionTypeCheck('optional', 'boolean', key, item);
        utils.optionTypeCheck('mapper', 'function', key, item);
        utils.optionTypeCheck('transform', 'function', key, item);
        utils.optionTypeCheck('sourceKey', 'string', key, item);
        utils.optionTypeCheck('getter', 'string', key, item);

        //check for illegal option groups
        utils.illegalOptionPairCheck('mapper', 'sourceKey', key, item);
        utils.illegalOptionPairCheck('mapper', 'transform', key, item);
        utils.illegalOptionPairCheck('getter', 'sourceKey', key, item);
        utils.illegalOptionPairCheck('getter', 'transform', key, item);
        utils.illegalOptionPairCheck('default', 'optional', key, item);
